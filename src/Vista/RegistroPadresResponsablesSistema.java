...
public class RegistroPadresResponsablesSistema extends javax.swing.JFrame {
     ...
     */
    public RegistroPadresResponsablesSistema() {
        initComponents();
        setLocationRelativeTo(null); //abre la ventana en la mitad
        setResizable(false);
        this.setContentPane(fondo);
        this.setTitle("Registros De Padres Al Sistema");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>ID Usuario:</html>");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("REGISTRO PADRE/RESPONSABLE AL SISTEMA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroPadresResponsablesSistema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroPadresResponsablesSistema().setVisible(true);
            }
        });
    }
